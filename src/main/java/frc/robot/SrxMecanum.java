 ...
 */
public class SrxMecanum extends RobotDriveBase {
  private static int instances = 0;

  private TalonSRX m_frontLeftMotor;
  private TalonSRX m_rearLeftMotor;
  private TalonSRX m_frontRightMotor;
  private TalonSRX m_rearRightMotor;
   ...
   */
  public SrxMecanum(TalonSRX frontLeftMotor, TalonSRX rearLeftMotor,
  TalonSRX frontRightMotor, TalonSRX rearRightMotor) {
 ...
 // @SuppressWarnings("ParameterName")
  ...
  public void initSendable(SendableBuilder builder) {
    ...
    builder.addDoubleProperty("Front left Motor Speed", () -> m_frontLeftMotor.getMotorOutputPercent(),
    value -> m_frontRightMotor.set(ControlMode.PercentOutput, value));
    builder.addDoubleProperty("Front Right Motor Speed", () -> -m_frontRightMotor.getMotorOutputPercent(),
        value -> m_frontRightMotor.set(ControlMode.PercentOutput, -value));
    builder.addDoubleProperty("Rear Leftt Motor Speed", () -> m_rearLeftMotor.getMotorOutputPercent(),
        value -> m_frontRightMotor.set(ControlMode.PercentOutput, value));
    builder.addDoubleProperty("Rear Right Motor Speed", () -> -m_rearRightMotor.getMotorOutputPercent(),
